...
const Features = () => {
    ...
    return (
        <section id="features" className='bg-[rgb(28,28,28)] flex flex-col w-full pt-16'>
            <div className="flex-1 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className='flex flex-col py-12'>
                    ...
                    <h1 data-aos="fade-up" className='lg:text-[3.4rem] md:text-[2.8rem] text-[2.4rem] lg:leading-[4rem] md:leading-[3.4rem] leading-[3rem] font-medium text-white py-4'>
                        Explore an array of features that elevate your <span className='text-[rgb(254,129,98)]'>Productivity</span> to new heights
                    </h1>
                    <h4 data-aos="fade-up" className='text-gray-500 lg:text-2xl md:text-xl text-lg max-w-2xl'>
                ...
                <div className="flex lg:flex-row flex-col items-center gap-10 py-16 text-center">
                    {
                        features.map((feature, index) => (
                            <div data-aos="fade-up" key={index} className="bg-[rgb(33,33,33)] border border-[#292929] rounded-[1.8rem] flex flex-col gap-4 items-center px-10 py-16 pt-20 h-[25rem] flex-1 lg:w-full md:w-[32rem] w-full">
                                <div className="text-white p-4 text-2xl bg-[rgb(130,71,255)] w-fit rounded-2xl">
                                    {feature.icon}
                                </div>
                                <h5 className="text-2xl font-semibold text-white">
                                    {feature.title}
                                </h5>
                                <p className="text-[rgb(118,117,117)] font-medium text-[1rem] leading-6" >
                                    {feature.description}
                                </p>
                            </div>
                        ))
                ...
                <div className="pt-16">
                    ...
                    <div className='text-center flex items-center flex-col max-w-3xl mx-auto pt-12'>
                        ...
                        <h1 data-aos="fade-up" className='lg:text-5xl md:text-4xl text-3xl font-semibold text-white p-4'>
                            Enable <span className='text-[rgb(254,129,98)]'>integration</span> with other popular tools and platforms
                        </h1>
                        <h4 data-aos="fade-up" className="text-[rgb(118,117,117)] font-medium lg:text-[1.3rem] lg:leading-6 md:text-xl max-w-xl">
