...
const Testimonials = () => {
    ...
    const testimonials = [
        ...
        },
        {
            ...
            job: "Director",
            review: "Manage Wise transformed our team's productivity. The intuitive interface and powerful features have made a significant impact on our daily operations"
        }
    ]
            ...
            <div className="flex-1 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-8">
                <div className='flex flex-col py-12'>
                    ...
                    <h1 data-aos="fade-up" className='lg:text-[3.4rem] md:text-[2.8rem] text-[2.4rem] lg:leading-[4rem] md:leading-[3.4rem] leading-[3rem] font-medium py-4'>
                        Hear from our <span className='text-[rgb(254,129,98)]'>Satisfied</span> clients
                    </h1>
            ...
            <Marquee direction="right" speed={40} autoFill={true} className="lg:mb-12 md:mb-10 mb-6 marquee" pauseOnHover={true}>
                {
                    testimonials.map((testimonial, index) => (
                        <div key={index} className="border border-gray-100 rounded-[1.8rem] flex flex-col gap-4 p-10 pt-14 w-[21rem] flex-1 mx-3">
                            ...
                            <div className="flex items-center gap-3 pt-5">
                                ...
                                <div className="flex flex-col">
                                    ...
                                    <p className="text-[rgb(136,135,135)] text-lg" >
                                        {testimonial.job}
                                    </p>
                                </div>
                            </div>
