...
const Heading = ({ smallHeadingEmoji, smallHeadingText, bigHeadingText, highLightedText, bottomText }) => {
    ...
    return (
        <div data-aos="fade-up" className='text-center flex items-center flex-col max-w-4xl mx-auto py-12'>
            ...
            }} className='lg:text-5xl md:text-5xl text-4xl font-semibold text-gray-800 p-4'>
            </h1>
            <h4 className='text-gray-500 lg:text-2xl md:text-xl text-lg lg:max-w-2xl md:max-w-xl px-10'>
                {bottomText}
            </h4>
        </div>
    )
